...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysqli_query($con,"SELECT * FROM orders where order_date Between '$from' and '$to'");
...
?>
									...
									<li>
										...
										<?php	
	$status='delivered';									 
$ret = mysqli_query($con,"SELECT * FROM orders where order_status!='$status' || order_status is null ");
...
<?php } ?>
								...
								<?php	
	$status='delivered';									 
$rt = mysqli_query($con,"SELECT * FROM orders where order_status='$status'");
